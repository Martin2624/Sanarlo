    ...
    <section className="block contact-section" id="contacto">
      <div className="container">
        ...
        <h2 className="section-title">
          Reservemos un <em>primer encuentro</em>.
        </h2>
        ...
        <div className="contact-grid">
          {/* COLUMNA 1: DOCTORALIA */}
          <div className="contact-card doctoralia-card">
            <h3 className="card-heading">Elige horario y reserva al instante</h3>
            <p className="card-subtext">
              Reserva directamente en la agenda en línea con confirmación inmediata.
            </p>
            <div className="doctoralia-wrapper">
              <DoctoraliaWidget />
            </div>
          </div>

          {/* COLUMNA 2: WHATSAPP E INFO */}
          <div className="contact-card wa-card">
            <h3 className="card-heading">¿Listo para comenzar?</h3>
            <p className="card-subtext">
            ...
            <a href={config.whatsappUrl} target="_blank" rel="noopener noreferrer" className="btn wa-btn">
